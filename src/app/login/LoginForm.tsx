    ...
    >
      ...
      {resetSuccess && (
        <motion.div
          ...
          className="mb-4 rounded-lg border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-400"
        >
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-[#111111]/80 p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_20px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        ...
        {oauthError && (
          <motion.div
            initial={{ opacity: 0, height: 0 }}
            animate={{ opacity: 1, height: "auto" }}
            className="mb-4 flex items-start gap-2 rounded-lg border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-400"
          >
        ...
        <a
          ...
          className="mb-4 flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.1] bg-white/[0.03] py-2.5 text-sm font-medium text-white/70 transition-all hover:border-white/20 hover:bg-white/[0.06] hover:text-white"
        >
        ...
        <form action={formAction} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-1.5 text-right">
              <Link href="/forgot-password" className="text-[11px] text-white/30 transition-colors hover:text-white/60">
                Forgot password?
              </Link>
            </div>
          </div>
